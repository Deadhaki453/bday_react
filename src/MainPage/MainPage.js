...
function MainPage() {
  ...
  const validate = () => {
    ...
    if (formData.password === "Akshita" && formData.password === formData.username) {
      newErrors.password = 'Username and password cannot be "Akshita"';
      newErrors.username = 'Username and password cannot be "Akshita"';
    }
    if (formData.username && formData.password && (formData.username === "Akshi" && formData.password === "Akshi")) {
      count++;
    }
    if (count === 1) {
      setShowToast(true);
